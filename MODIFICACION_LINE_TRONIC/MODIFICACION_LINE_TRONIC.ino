...
#define MOTORD_AIN1  8 
#define MOTORD_AIN2  7 
#define MOTORD_PWM   9

#define MOTORI_AIN1    5
#define MOTORI_AIN2    4
#define MOTORI_PWM     3
...
#define COLOR_LINE false  //true linea blanca
//#define COLOR_LINE false  //false linea negra

unsigned char pins[NUM_SENSORS] = {14,15,16,17,18,2,10,19}; // SENSORES DEL 0 AL 8 QTR8
...
const int VELCIDAD_MAXIMA =   50;    //Velocidad Maxima (entre 0 y 255)
