...
//TCCR2B |=B00000111;//clkI/O/1024
 ...
 // TIMSK2 = (TIMSK2 & B11111000) | 0x07;
  ...
  DDRD=B00101000;//pinmode(3,5output) PORTD=B01000000;
  DDRB=B00101110;//pinmode(9,11,10,13,output ) // pendiente por decidir si poner como salidas los pwm 
   DDRD &=~B10010000;//ENTRADAS 4,7
   DDRC &=~B00010000;//ENTRADAS A4-pendiente por revisar - la puse como entrada y es salida analogica 
