...
float Kd = 10;  //  calibracion derivativo2.65

int frente = 220;   // Velocidad a la que ira el motor hacia adelante cuando pierda la linea max 255
int reversa = 200;  // Velocidad a la que ira el motor hacia atras cuando pierda la linea    max 255

int color = 2;      // 1 linea negra 2 linea blanca
//********CONEXION DE PUERTOS****************************************************************************************************

int OP = A0;   // A0 conectdado a OP    SALIDA DEL MULTIPLEXOR
int S0 = A4;   // A4 conectado a S0     S0 DEL MULTIPLEXOR
int S1 = A3;   // A3 conectado a S1     S1 DEL MULTIPLEXOR
int S2 = A2;   // A1 conectado a S2     S2 DEL MULTIPLEXOR
int S3 = A1;   // A2 conectado a S3     S3 DEL MULTIPLEXOR
