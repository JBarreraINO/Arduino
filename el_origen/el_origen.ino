...
Servo ESC;
int velocidad = 220; // Velocidad crucero de robot max 255

float Kp = 0.7; // calibracion proporcional.2
float Kd = 7.65;  //  calibracion derivativo2.65

int frente = 220;   // Velocidad a la que ira el motor hacia adelante cuando pierda la linea max 255
int reversa = 220;  // Velocidad a la que ira el motor hacia atras cuando pierda la linea    max 255
