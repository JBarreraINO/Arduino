...
void loop() {
  ...
  lectura();
  Serial.print((String) sensores[0]+"A"+sensores[1]+"B"+sensores[2]+"C" + sensores[3]+"D"+sensores[4]+"E"+sensores[5]+"F"+sensores[6]+"G"+sensores[7]+"H"+sensores[8]+"I" +sensores[9]+"J"+sensores[10]+"K"+sensores[11]+"L" +sensores[12]+"M"+sensores[13]+"N" +sensores[14]+"O"+sensores[15]+"P"+"\n");
...
void parse(){
  ...
  String str_velocidad;
  indexOfA=dataIn.indexOf("A");
  if(indexOfA > -1){str_velocidad = dataIn.substring(0,indexOfA); velocidad1= str_velocidad.toInt(); }
}
void lectura(){
