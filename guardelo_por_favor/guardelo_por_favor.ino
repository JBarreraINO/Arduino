...
int velocidad = 105; // Velocidad crucero de robot max 255

float Kp = 0.25; // calibracion proporcional.2
float Kd = 4.60;  //  calibracion derivativo2.65

int frente = 150;   // Velocidad a la que ira el motor hacia adelante cuando pierda la linea max 255
int reversa = 150;  // Velocidad a la que ira el motor hacia atras cuando pierda la linea    max 255
