...
void loop(){
 ...
 if (pulso >= 400) {                   // Enciende led 3 cuando el pulso pasa de un valor (debe ajustarse)
    digitalWrite(3, HIGH);
 }  
 else{
    digitalWrite(3, LOW);
   ...
   Serial.println(BPM);                          // envia el valor del pulso por el puerto serie  (desabilitarla si habilita la anterior linea)
