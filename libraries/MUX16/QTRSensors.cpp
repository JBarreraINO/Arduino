...
void QTRSensors::initializeCalibrationVectors (unsigned int **calibratedMinimum, unsigned int **calibratedMaximum){
    int i = 0;
...
// or if you just want the emitters on all the time and don't want to
// use an I/O pin to control it, use a value of 255 (QTR_NO_EMITTER_PIN).
void QTRSensorsAnalog::init(unsigned char* pins,unsigned char numSensors, unsigned char numSamplesPerSensor,unsigned char emitterPin)
{
    QTRSensors::init(pins, numSensors, emitterPin);
...
QTRSensorsMux::QTRSensorsMux(unsigned char* pins, unsigned char numSensors, unsigned char numSamplesPerSensor,unsigned char inPin, unsigned char* muxPins)
{
    calibratedMinimumOn = 0;
    calibratedMaximumOn = 0;
    calibratedMinimumOff = 0;
...
void QTRSensorsMux::init (unsigned char* pins, unsigned char numSensors, unsigned char numSamplesPerSensor,unsigned char inPin, unsigned char* muxPins)
{
